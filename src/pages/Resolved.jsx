...
export const Resolved = () => {
  ...
  const filteredTasks = useMemo(() => {
    let filtered = resolvedTasks.filter((task) => {
      if (searchQuery) {
    ...
    return filtered;
  }, [resolvedTasks, searchQuery, filters, sortBy]);
